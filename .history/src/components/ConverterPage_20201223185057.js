...
import { Grid, Container, Box, FormControl, FormGroup, Modal, Input, InputLabel, Button, Checkbox, MenuItem } from '@material-ui/core';
...
// useEffect(() => {
    ...
    return (
        ...
        <div>
            ...
            {elementsArray ? elementsArray.map(ele => ): null}
