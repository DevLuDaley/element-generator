...
const ConverterPage = (e) => {
    ...
    var [selectedElement, setSelectedElement] = useState(optionsArray[0].k)
    ...
    const handleChange = (e) => {
        ...
        console.log('🚀 ~ file: ConverterPage.js ~ line 21 ~ onSubmit', "HANDLE CHANGE", e.target)
        setSelected(true)
        // Select.value = "p"
    }
