...
import { Grid, Container, Box, FormControl, FormGroup, MuiFormGroup, Input, InputLabel, Button, Checkbox } from '@material-ui/core';
...
// useEffect(() => {
    ...
    return (
        ...
        <div>
            <MuiFormGroup id='convert-to-element-form' onSubmit={handleSubmit}>
