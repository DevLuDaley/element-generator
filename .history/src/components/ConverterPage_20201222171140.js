...
import { Grid, Container, Box, FormControl, Input, InputLabel, Button, Checkbox } from '@material-ui/core';
...
const [copied, setCopied] = useState(false)
    ...
    return (
        ...
        <div>
            <FormControl id='convert-to-element-form' onSubmit={handleSubmit}>
